    ...
    tabItem(
        ...
        fluidRow(
            box(
                ...
                p(
                    "This leaflet map shows the top 1000 cities (based on the data selection) based on the number of attacks.
        ...
        fluidRow(
            box(
                ...
                p(
                    "This 3D globe picks a sample of 1000 attacks based on the data filters set and visualizes the number of casualties as a 3D bar.
